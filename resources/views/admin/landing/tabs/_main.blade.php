...
<div class="form-group row">
    <label class="col-md-3 text-right @if ($lang == config('translatable.locale')) required @endif"
        for="page_title_{{ $lang }}">Заголовок</label>
    <div class="col-md-9">
        <input type="text" name="page_data[{{ $lang }}][title]"
            value="{{ old('page_data.' . $lang . '.title', $data[$lang]['title'] ?? '') }}"
            id="page_title_{{ $lang }}"
            class="form-control{{ $errors->has('page_data.' . $lang . '.title') ? ' is-invalid' : '' }}">
...
<div class="form-group row">
    <label class="col-md-3 text-right">Главаный экран</label>
    <div class="col-md-9">
        <div id="main_screen_{{$lang}}" class="card card-default card-component" style="position: relative;top:0;left:0;">
                ...
                <div class="card-title move-label d-inline" style="margin-bottom: 2px!important;">
                    ...
                    <span class="float-right">
                        <div class="d-inline component-visibility-switch custom-switch custom-switch-off-danger custom-switch-on-success"
                            ...
                            <input type="hidden" name="main_screen[data][{{ $lang }}][visibility]"
                                value="0">
                            <input type="checkbox" name="main_screen[data][{{ $lang }}][visibility]"
                                ...
                                @if (isset($data[$lang]['main_screen']['visibility']) && $data[$lang]['main_screen']['visibility'] == 1) checked @endif>
                            <label class="custom-control-label"
                                for="component_visibility_main_screen_{{ $lang }}"></label>
                        </div>
                        <a href="#collapse_main_screen_{{ $lang }}"
                            class="text-info collapse-button ml-2 collapsed" data-toggle="collapse"
                            aria-expanded="false">
            ...
            <div id="collapse_main_screen_{{ $lang }}" class="card-body mt-1 collapse {{-- {{$field['collapse'] ?? ''}} --}}">
                <div class="row">
                    <div class="col-md-12">
                        <label for="page_description_{{ $lang }}">Контент</label>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <label class="col-3">Использовать изображение</label>
                            <select class="form-control col-9" style="width: 100px"
                                name="main_screen[data][{{ $lang }}][with_image]">
                                <option value="0" @if (isset($data[$lang]['main_screen']['with_image']) && $data[$lang]['main_screen']['with_image'] == 0) selected @endif>Нет
                                </option>
                                <option value="1" @if (isset($data[$lang]['main_screen']['with_image']) && $data[$lang]['main_screen']['with_image'] == 1) selected @endif>Да
                                </option>
                            </select>
                        </div>
                    </div>
