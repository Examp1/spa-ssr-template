...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="{{ route('roles.update', $model->id) }}">
        @method('PUT')
        @csrf
                ...
                <div class="card">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="permission-tab" data-toggle="tab" href="#permission" role="tab"
                                    aria-controls="permission" aria-selected="false">{{ __('Permissions') }}</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane fade" id="permission" role="tabpanel" aria-labelledby="permission-tab">
                            @include('admin.access.roles._permission', [
                                'model' => $model,
