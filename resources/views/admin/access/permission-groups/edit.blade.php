...
@section('content')
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('permission-groups.index') }}">{{ __('Permissions Groups') }}</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Edit') }}</li>
        </ol>
    </nav>

    <form class="form-horizontal" method="POST" action="{{ route('permission-groups.update', $model->id) }}">
        @method('PUT')
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @include('admin.access.permission-groups._form', ['model' => $model])
