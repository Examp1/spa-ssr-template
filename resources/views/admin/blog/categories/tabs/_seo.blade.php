...
<div class="form-group row">
    ...
    <div class="col-md-9">
       <span class="btn btn-primary btn-meta-generate-single-{{$lang}}"
             data-lang="{{ $lang }}"
             data-route="{{route('blog.categories.meta-generate')}}"
             data-template_title="{{app(\App\Modules\Setting\Setting::class)->get('blogcategories_template_title',$lang)}}"
             data-template_desc="{{app(\App\Modules\Setting\Setting::class)->get('blogcategories_template_description',$lang)}}"
