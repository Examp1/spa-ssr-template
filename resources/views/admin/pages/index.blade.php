            ...
            <div class="card">
                <div class="card-header">
                    @can('setting_page_view')
                        <a href="/admin/settings/page" class="float-right btn btn-dark" style="margin-left: 10px"
                            title="{{ __('Settings') }}">
                            <i class="fa fa-cog"></i>
                        </a>
                    @endcan
                    @can('pages_create')
                        <a href="{{ route('pages.create') }}" class="btn btn-success text-white float-right">
                ...
                <div class="card-body">
                                        ...
                                        <div style="display: flex">
                                            <div style="margin-left: 10px">
                                                <form action="{{ route('pages.destroy', $item->id) }}" method="POST">
                                                    ...
                                                    <a href="{{ route('pages.copy', ['id' => $item->id]) }}"
                    ...
                    <form action="{{ route('pages.delete-selected') }}" method="post" id="delete_sel_form">
                        @csrf
