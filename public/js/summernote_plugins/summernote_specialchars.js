    ...
    $.extend($.summernote.plugins, {
        'specialchars': function(context) {
            ...
            var specialCharDataSet = [
                '&euro;','$','&#8372;','&#8383;','&#164;','&trade;','&copy;','&reg;','%','&permil;','&laquo;','&raquo;','&ldquo;','&rdquo;','&lt;',
                '&gt;','&le;','&ge;','&minus;','&plus;','&plusmn;','&divide;','&times;','&sup1;','&sup2;',
                '&sup3;','&frac14;','&frac12;','&frac34;','&ndash;','&mdash;','&#127793;','&#127808;','&#9752;','&#128522;','&#39;','🡆','🢂','🡽','→'
            ];

            context.memo('button.specialchars', function() {
                return ui.button({
                    contents: '<i class="fa fa-font fa-flip-vertical"></i>',
                    tooltip: 'Специальные символы',
                    click: function() {
                        self.show();
                    },
                }).render();
