<script type="text/javascript">
    (function () {
        $(document).on('click', '.simple-text-add-btn-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.simple-text-btn-list-template');
            const container = $(this).parent().find('.simple-text-btn-list-container');
