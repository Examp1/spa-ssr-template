<script type="text/javascript">
    (function () {
        $(document).on('click', '.simple-title-add-btn-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.simple-title-btn-list-template');
            const container = $(this).parent().find('.simple-title-btn-list-container');
