...
<div id="collapse{{ $key }}_{{$lang}}" class="card-body mt-1 collapse show">
    ...
    <div class="tab-content">
            ...
            <div class="row">
                <div class="input-group">
                    <div style="display: none;">
                        <div data-item-id="#imageInputPlaceholder1" class="accordion-list-template item-group m-1 border border-grey-light p-1 d-flex align-items-center">
                            <div class="col-12">
                    ...
                    <div class="accordion-list-container w-100">
                ...
                <button type="button" class="btn btn-info btn-sm add-accordion-list-item_{{$lang}} d-block mt-2">Додати елемент</button>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="pills_btns_{{ $key }}_{{$lang}}">
            @include('constructor::pieces.btns',['name_component'=>'accordion','key' => $key,'params' => $params,'content' => $content, 'lang' => $lang])
        </div>
    </div>
</div>
