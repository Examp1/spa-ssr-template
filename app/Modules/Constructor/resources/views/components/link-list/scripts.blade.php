<script type="text/javascript">
    (function () {
        ...
        $(document).on('click', '.add-link-list-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.link-list-list-template');
            const container = $(this).parent().find('.link-list-list-container');
        ...
        $(document).on('click', '.link-list-add-btn-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.link-list-btn-list-template');
            const container = $(this).parent().find('.link-list-btn-list-container');
