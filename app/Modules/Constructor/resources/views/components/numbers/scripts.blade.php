<script type="text/javascript">
    (function () {
        ...
        $(document).on('click', '.add-numbers-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.numbers-list-template');
            const container = $(this).parent().find('.numbers-list-container');
        ...
        $(document).on('click', '.numbers-add-btn-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.numbers-btn-list-template');
            const container = $(this).parent().find('.numbers-btn-list-container');
