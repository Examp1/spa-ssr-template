<script type="text/javascript">
    (function () {
        ...
        $(document).on('click', '.add-list-stages-item_{{$lang}}', function () {
            const template = $(this).parent().find('.list-stages-template');
            const container = $(this).parent().find('.list-stages-container');
        ...
        $(document).on('click', '.stages-add-btn-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.stages-btn-list-template');
            const container = $(this).parent().find('.stages-btn-list-container');
