<script type="text/javascript">
    (function () {
        ...
        $(document).on('click', '.advantages-add-btn-list-item_{{$lang}}', function () {
            const template = $(this).parent().find('.advantages-btn-list-template');
            const container = $(this).parent().find('.advantages-btn-list-container');
