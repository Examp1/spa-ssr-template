    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="pills_main_{{ $key }}_{{$lang}}">
            ...
            <div class="row">
                ...
                <button type="button" class="btn btn-info btn-sm add-advantages-list-item_{{$lang}} d-block mt-2">Додати елемент</button>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="pills_btns_{{ $key }}_{{$lang}}">
            @include('constructor::pieces.btns',['name_component'=>'advantages','key' => $key,'params' => $params,'content' => $content, 'lang' => $lang])
        </div>
    </div>
</div>
