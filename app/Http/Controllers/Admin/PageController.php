...
class PageController extends Controller
{
    ...
    public function __construct(Adapter $adapter, Pages $modelClass)
    {
        ...
        $this->tableTranslationsName = 'page_translations';
        $this->translationEntityAttribute = 'pages_id';
        $this->translationClassName = 'App\Models\Translations\PageTranslation';

        $this->middleware('permission:pages_view')->only('index');
        $this->middleware('permission:pages_create')->only('create', 'store');
        $this->middleware('permission:pages_edit')->only('edit', 'update');
