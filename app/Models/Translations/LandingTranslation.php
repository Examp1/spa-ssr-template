 ...
 */
class LandingTranslation extends Model implements HasConstructor
{
    use HasFactory;
    use Constructorable;
    ...
    public $originalModel = 'App\Models\Landing';
    public $entityAttribute = 'landing_id';
...
//            'blocks-slider'        => ComponentCollections::blocksSlider(),
            ...
            'widget'               => ComponentCollections::widget(WIDGET_GROUP_LANDING),
