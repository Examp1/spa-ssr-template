...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="{{ route('coupons.update', $model->id) }}">
        @csrf
        @method('PUT')
                                ...
                                <div class="col-md-9">
                                    <select name="type">
                                        @foreach ($discount_types as $type => $type_name)
                                            <option value="{{ $type }}" @if ($model->type == $type) selected @endif>{{ __($type_name) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="quantity"
                                        value="{{ old('quantity', $model->quantity ?? '') }}" id="page_quantity"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="material-switch pull-left">
                                        ...
                                        <input id="someSwitchOptionSuccess" name="status" value="1"
                                            type="checkbox" {{ old('status', $model->status) ? ' checked' : '' }} />
