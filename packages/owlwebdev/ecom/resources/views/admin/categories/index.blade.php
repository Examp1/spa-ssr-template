            ...
            <div class="card">
                <div class="card-header">
                    @can('setting_categories_view')
                        <a href="/admin/settings/categories" class="float-right btn btn-dark" style="margin-left: 10px"
                            title="{{ __('Settings') }}">
                            <i class="fa fa-cog"></i>
                        </a>
                    @endcan
                    @can('categories_create')
                        <a href="{{ route('categories.create') }}" class="btn btn-success text-white float-right">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered imSortingTableLib">
                        <thead>
                            <tr>
                                ...
                                {{-- JIRA --}}
                                {{-- дата створення - убрать в категории и в продукте  и убрал на строке 108 --}}
                    ...
                    <form action="{{ route('categories.delete-selected') }}" method="post" id="delete_sel_form">
                        @csrf
