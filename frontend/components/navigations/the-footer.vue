<template>
    <footer class="footer">
        <div class="container container-1200">
            <nav class="menu">
                <app-link v-for="(li, idx) in getFooterMenu" :key="'li' + idx" :to="li.url">
                    {{ li.name }}
                </app-link>
            </nav>
            <hr>
            <div class="paymentsWrp">
                <img class="payments" src="@/assets/images/payments.png" alt="">
            </div>
            <div class="bottom-part">
                <a href="https://owlweb.com.ua/" target="_blank" rel="nofollow" class="created">Created by<svg width="18"
                        height="11" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 226.000000 141.000000"
                        preserveAspectRatio="xMidYMid meet">
                        <g transform="translate(0.000000,141.000000) scale(0.100000,-0.100000)"
                            fill="rgba(242, 242, 242, 0.3)" stroke="none">
                ...
                <p class="copy">{{ getSettings.copyright || 'copyright' }}</p>
            </div>
            <span class="up" @click.stop="toTop"><i class="icon icon-big-arrow"></i></span>
        </div>
    </footer>
</template>
...
export default {
    ...
    computed: {
        ...mapGetters({
            getSettings: 'app_settings/getSettings',
...
.footer {
    ...
    .copy {
        color: var(--gray-gray-200, #CBCBCB);
        font-size: 16px;
        font-style: normal;
        font-weight: 400;
        line-height: 125%;
    ...
    .up {
        ...
        width: 24px;
        height: 24px;
        border: 2px solid var(--gray-gray-500, #656565);
        display: flex;
        justify-content: center;
        align-items: center;
        font-size: 12px;
